...
@Extension
public class TestResultsAnalyzerExtension extends TransientActionFactory<Job> implements
    Describable<TestResultsAnalyzerExtension> {

  //based on DiskUsageProjectActionFactory
  @Extension
  public static final DescriptorImpl DESCRIPTOR = new DescriptorImpl();
  private static final Logger log = LoggerFactory.getLogger(TestResultsAnalyzerExtension.class);

  @Override
  public
  @Nonnull
  Collection<? extends Action> createFor(@Nonnull Job target) {
  ...
  public static class DescriptorImpl extends Descriptor<TestResultsAnalyzerExtension> {
    ...
    public boolean configure(StaplerRequest req, JSONObject formData) {
      try {
        ...
        log.warn("Problem while configuring", e);
      }
      save();
      return true;
    }
    ...
    public FormValidation doCheckSkippedRepresentation(
        @QueryParameter String skippedRepresentation) {
